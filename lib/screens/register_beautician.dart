...
class BeauticianRegisterScreen extends StatefulWidget {
  const BeauticianRegisterScreen({super.key});

  @override
  State<BeauticianRegisterScreen> createState() => _MyWidgetState();
}

class _MyWidgetState extends State<BeauticianRegisterScreen> {
